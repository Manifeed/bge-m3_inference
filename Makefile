...
CANONICALIZED_ENV := export BGE_M3_INFERENCE_API_KEY="$${BGE_M3_INFERENCE_API_KEY:-}"; \
	export BGE_M3_INFERENCE_PORT="$${BGE_M3_INFERENCE_PORT:-8000}"; \
	export BGE_M3_INFERENCE_CONTAINER_NAME="$${BGE_M3_INFERENCE_CONTAINER_NAME:-bge-m3_inference}"; \
...
benchmark:
	@$(LOAD_DOTENV) $(CANONICALIZED_ENV) $(PYTHON) scripts/benchmark_inference.py \
		...
		--api-key "$${BGE_M3_INFERENCE_API_KEY:?Set BGE_M3_INFERENCE_API_KEY}" \
